        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassroomID = table.Column<string>(maxLength: 20, nullable: true),
                    ClassroomPASS = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CourseBuyId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseBuy", x => x.CourseBuyId);
                    table.ForeignKey(
                        name: "FK_CourseBuy_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseBuy_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseBuy_CourseId",
                table: "CourseBuy",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseBuy_StudentId",
                table: "CourseBuy",
                column: "StudentId");
